     ...
     ?>
      ...
      <div class="container">
        <div class="row">
          <div class="col">
              <h1>Cadastro</h1>
              <form method="POST" action="edit_script.php.php">
                <div class="mb-3">
                   <label for="exampleInputEmail1" class="form-label">Nome Completo</label>
                   <input type="text" class="form-control" name="nome" placeholder="Digite Aqui" required value="<?php echo $linha['nome']; ?>">
                 </div>

                  <div class="mb-3">
                   <label for="exampleInputEmail1" class="form-label">Email</label>
                   <input type="email" class="form-control" name="email" placeholder="Digite Aqui" required value="<?php echo $linha['email']; ?>">
                 </div>
